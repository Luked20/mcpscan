...
const STATS: ScanStats = { filesExamined: 40, filesWithTools: 3, tools: 12, servers: 2, skills: 1, sourceFiles: 0, unreadable: 0, suppressed: 0, baselined: 0, liveTools: 0 };
...
describe('formatPretty: a scan that looked at nothing', () => {
  const zero: ScanStats = { filesExamined: 0, filesWithTools: 0, tools: 0, servers: 0, skills: 0, sourceFiles: 0, unreadable: 0, suppressed: 0, baselined: 0, liveTools: 0 };
