...
describe('nothing to scan', () => {
  ...
  it('stats separate files scanned from files with tools', async () => {
    ...
    expect(r.stats).toEqual({ filesExamined: 1, filesWithTools: 1, tools: 1, servers: 0, skills: 0, resources: 0, prompts: 0, sourceFiles: 0, unreadable: 0, suppressed: 0, baselined: 0, liveTools: 0 });
  });
